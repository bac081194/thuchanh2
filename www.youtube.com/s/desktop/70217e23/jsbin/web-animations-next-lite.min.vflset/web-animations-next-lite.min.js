...
(function () {
  ...
  (function (y, v) {
    ...
    function h(p, w, z) {
      ...
      "number" != typeof p || isNaN(p)
        ? void 0 !== p &&
          Object.getOwnPropertyNames(p).forEach(function (B) {
            if ("auto" != p[B]) {
              if ("number" == typeof A[B] || "duration" == B)
                if ("number" != typeof p[B] || isNaN(p[B])) return;
              ("fill" == B && -1 == e.indexOf(p[B])) ||
                ("direction" == B && -1 == m.indexOf(p[B])) ||
                ("playbackRate" == B &&
                  1 !== p[B] &&
                  y.isDeprecated(
    ...
    function b(p) {
      ...
      var w = q.exec(p);
      return w
        ? d.apply(this, w.slice(1).map(Number))
        : (w = C.exec(p))
        ? a(Number(w[1]), { start: l, middle: r, end: t }[w[2]])
        : (p = x[p])
        ? p
        : n;
    }
    function g(p, w, z) {
      ...
      return w < Math.min(z.delay, A)
        ? 1
        : w >= Math.min(z.delay + p, A)
        ? 2
        : 3;
    }
    ...
    k.prototype = {
      _setMember: function (p, w) {
        this["_" + p] = w;
        this._effect &&
          ((this._effect._timingInput[p] = w),
          (this._effect._timing = y.normalizeTimingInput(
            this._effect._timingInput
          )),
          (this._effect.activeDuration = y.calculateActiveDuration(
      ...
      set iterationStart(p) {
        if ((isNaN(p) || 0 > p) && f())
          throw new TypeError(
            "iterationStart must be a non-negative number, received: " + p
          );
      ...
      set duration(p) {
        if ("auto" != p && (isNaN(p) || 0 > p) && f())
          throw new TypeError(
            "duration must be non-negative or auto, received: " + p
          );
      ...
      set iterations(p) {
        if ((isNaN(p) || 0 > p) && f())
          throw new TypeError(
            "iterations must be non-negative, received: " + p
          );
    ...
    var l = 1,
      ...
      x = {
        ...
        "ease-in": d(0.42, 0, 1, 1),
        "ease-out": d(0, 0, 0.58, 1),
        "ease-in-out": d(0.42, 0, 0.58, 1),
        "step-start": a(1, l),
        "step-middle": a(1, r),
        "step-end": a(1, t),
      },
    ...
    y.numericTimingToObject = function (p) {
      "number" == typeof p &&
        (p = isNaN(p) ? { duration: 0 } : { duration: p });
      return p;
    };
    ...
    y.calculateActiveDuration = function (p) {
      var w = Math,
        z = w.abs;
      var A =
        0 === p.duration || 0 === p.iterations ? 0 : p.duration * p.iterations;
    ...
    y.calculateIterationProgress = function (p, w, z) {
      ...
      "normal" !== A &&
        "reverse" !== A &&
        ("alternate-reverse" === A && (B += 1),
        (w = "normal"),
        Infinity !== B && 0 !== B % 2 && (w = "reverse"));
  ...
  (function (y, v) {
      ...
      for (b in a)
        if (!(b in ["easing", "offset", "composite"])) {
          ...
          for (var e, m = g.length, n = 0; n < m; n++)
            (e = {}),
              (e.offset = "offset" in a ? a.offset : 1 == m ? 1 : n / (m - 1)),
    ...
    var f = {
        background:
          "backgroundImage backgroundPosition backgroundSize backgroundRepeat backgroundAttachment backgroundOrigin backgroundClip backgroundColor".split(
            " "
          ),
        border:
          "borderTopColor borderTopStyle borderTopWidth borderRightColor borderRightStyle borderRightWidth borderBottomColor borderBottomStyle borderBottomWidth borderLeftColor borderLeftStyle borderLeftWidth".split(
            " "
          ),
        borderBottom: [
          "borderBottomWidth",
    ...
    y.normalizeKeyframes = function (a) {
      ...
      var b = a.map(function (n) {
        ...
        for (r in n) {
          ...
          if (
            "display" !== C &&
            0 !== C.lastIndexOf("animation", 0) &&
            0 !== C.lastIndexOf("transition", 0)
          )
            if ((C = f[u]))
  ...
  (function () {
    ...
    (function (k, f, h) {
      function d(c) {
        ...
        for (var n in b)
          if (((c = b[n]), 0 != c[0].offset || 1 != c[c.length - 1].offset))
            throw {
              type: DOMException.NOT_SUPPORTED_ERR,
              name: "NotSupportedError",
    ...
    (function (k, f, h) {
      ...
      f.propertyInterpolation = function (b, g, e) {
        ...
        /-/.test(b) &&
          ...
          (m = d(b));
        if ("initial" == g || "initial" == e)
          "initial" == g && (g = c[m]), "initial" == e && (e = c[m]);
        b = g == e ? [] : a[m];
    ...
    (function (k, f) {
      function h(d, a, c) {
        if ("number" == typeof d && "number" == typeof a)
          return d * (1 - c) + a * c;
        if ("boolean" == typeof d && "boolean" == typeof a)
          return 0.5 > c ? d : a;
      ...
      f.Animation.prototype = {
        _ensureAlive: function () {
          ...
          this._inTimeline ||
            ...
            ((this._inTimeline = !0), f.timeline._animations.push(this));
        },
        _tickCurrentTime: function (a, c) {
          a != this._currentTime &&
            ...
            this._isFinished &&
              !c &&
              (this._currentTime =
                0 < this._playbackRate ? this._totalDuration : 0),
            this._ensureAlive());
        },
        get currentTime() {
        ...
        get _isFinished() {
          return (
            ...
            ((0 < this._playbackRate &&
              ...
              (0 > this._playbackRate && 0 >= this._currentTime))
          );
        },
        get _totalDuration() {
        ...
        _rewind: function () {
          if (0 <= this._playbackRate) this._currentTime = 0;
          else if (Infinity > this._totalDuration)
            this._currentTime = this._totalDuration;
          else
        ...
        removeEventListener: function (a, c) {
          "finish" == a &&
            ((a = this._finishHandlers.indexOf(c)),
    ...
    (function (k, f, h) {
      ...
      function g(q, C, p) {
        ...
        p.forEach(function (D) {
          D._tick(q, C);
          D._inEffect
            ? (z.push(D._effect), D._markTarget())
            : (w.push(D._effect), D._unmarkTarget());
          D._needsTick && (l = !0);
    ...
    (function (k) {
      function f(c, b) {
        ...
        if (g)
          return (
            (g = c.ignoreCase ? g[0].toLowerCase() : g[0]),
            [g, b.substr(g.length)]
          );
      }
      function h(c, b) {
      ...
      function a(c, b, g, e, m) {
        for (
          var n = [], l = [], r = [], t = d(e.length, m.length), x = 0;
          x < t;
          x++
        ) {
    ...
    (function (k) {
      ...
      var h = function (d, a, c, b) {
        ...
        function (d, a) {
          for (
            ;
            d.lengths.length < Math.max(d.lengths.length, a.lengths.length);

          )
            d.lengths.push({ px: 0 });
          for (
            ;
            a.lengths.length < Math.max(d.lengths.length, a.lengths.length);
          ...
          if (d.inset == a.inset && !!d.color == !!a.color) {
            ...
            d.color &&
              a.color &&
              ((a = k.mergeColors(d.color, a.color)),
              (g[1] = a[0]),
              (e[1] = a[1]),
              (b = a[2]));
            return [
    ...
    (function (k, f) {
      ...
      k.addPropertiesHandler(a, c(0, Infinity), [
        "border-image-width",
        "line-height",
      ]);
    ...
    (function (k, f) {
      ...
      k.addPropertiesHandler(
        h,
        d,
        "background-color border-bottom-color border-left-color border-right-color border-top-color color fill flood-color lighting-color outline-color stop-color stroke text-decoration-color".split(
          " "
        )
      );
    ...
    (function (k, f) {
      ...
      function d(m, n) {
        ...
        if ("0" == n && 0 <= "px".search(m)) return { px: 0 };
        if (/^[^(]*$|^calc/.test(n)) {
          n = n.replace(/calc\(/g, "(");
          var l = {};
          ...
          for (
            var r = n
                ...
                .replace(new RegExp("N" + m, "g"), "D")
                .replace(/\s[+-]\s/g, "O")
                .replace(/\s/g, ""),
              t = [/N\*(D)/g, /(N|D)[*/]N/g, /(N|D)O\1/g, /\((N|D)\)/g],
              x = 0;
            x < t.length;

          )
            t[x].test(r) ? ((r = r.replace(t[x], "$1")), (x = 0)) : x++;
          if ("D" == r) {
            for (var u in l) {
              r = h(
                n
                  .replace(new RegExp("U" + u, "g"), "")
                  .replace(new RegExp(m, "g"), "*0")
              );
      ...
      var b = d.bind(
        null,
        RegExp("px|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc", "g")
      );
      f = d.bind(
        null,
        RegExp("px|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|%", "g")
      ...
      k.addPropertiesHandler(
        f,
        a,
        "border-bottom-width border-image-width border-left-width border-right-width border-top-width flex-basis font-size height line-height max-height max-width outline-width width".split(
          " "
        )
      );
      k.addPropertiesHandler(
    ...
    (function (k, f) {
      ...
      function d(a) {
        if (
          (a = k.consumeList(
            [
              k.ignore(k.consumeToken.bind(null, /^rect/)),
              k.ignore(k.consumeToken.bind(null, /^\(/)),
              k.consumeRepeated.bind(null, h, /^,/),
              k.ignore(k.consumeToken.bind(null, /^\)/)),
            ],
            a
          )) &&
      ...
      f = k.mergeWrappedNestedRepeated.bind(
        null,
        function (a) {
          return "rect(" + a + ")";
        },
        function (a, c) {
          return "auto" == a || "auto" == c
            ? [
                !0,
                !1,
                function (b) {
              ...
              if (
                ...
                if (q != B)
                  if (
                    A[2] &&
                    E[2] &&
                    q.replace(/[xy]/, "") == B.replace(/[xy]/, "")
                  )
                    (q = q.replace(/[xy]/, "")), (D = A[2](D)), (H = E[2](H));
                  else if (A[1] && E[1] && g(q) == g(B))
                    (q = g(q)), (D = A[1](D)), (H = E[1](H));
                  else {
                    if (!t) return;
                    A = b(l, r);
                    C = [A[0]];
                ...
                for (var M = [], K = 0; K < D.length; K++)
                  (A = (
                    "number" == typeof D[K] ? k.mergeNumbers : k.mergeDimensions
                  )(D[K], H[K])),
                    (E[K] = A[0]),
                    (B[K] = A[1]),
                    M.push(A[2]);
    ...
    if (void 0 === document.createElement("div").animate([]).oncancel) {
      ...
      window.Element.prototype.animate = function (f, h) {
        ...
        f.removeEventListener = function (b, g) {
          "cancel" == b
            ? ((b = this._cancelHandlers.indexOf(g)),
              0 <= b && this._cancelHandlers.splice(b, 1))
            : c.call(this, b, g);
        };
        return f;
      };
  ...
  (function (y) {
    ...
    try {
      var h =
        "0" == getComputedStyle(v).getPropertyValue("opacity") ? "1" : "0";
  ...
  (function (y, v, k) {
    ...
    v.AnimationTimeline.prototype = {
      ...
      _updateAnimationsPromises: function () {
        v.animationsWithPromises = v.animationsWithPromises.filter(function (
          c
        ) {
    ...
    v.Animation.prototype = {
      _updatePromises: function () {
        ...
        this._readyPromise &&
          ...
          ("idle" == h
            ...
            : "pending" == h && (this._readyPromise = void 0));
        this._finishedPromise &&
          ...
          ("idle" == h
            ...
            : "finished" == f && (this._finishedPromise = void 0));
      ...
      _rebuildUnderlyingAnimation: function () {
        ...
        if (!this.effect || this.effect instanceof window.KeyframeEffect)
          (this._animation = v.newUnderlyingAnimationForKeyframeEffect(
            this.effect
          )),
        ...
        this.effect &&
          ...
          v.bindAnimationForCustomEffect(this);
        f &&
          (1 != h && (this.playbackRate = h),
          null !== a
            ? (this.startTime = a)
            : null !== c
            ? (this.currentTime = c)
        ...
        if (this.effect && "idle" != this.playState) {
          ...
          this._childAnimations.forEach(
            function (h) {
              ...
              this.effect instanceof window.SequenceEffect &&
                (f += v.groupChildDuration(h.effect));
            }.bind(this)
          );
        }
      },
      ...
      _arrangeChildren: function (f, h) {
        null === this.startTime
          ? (f.currentTime = this.currentTime - h / this.playbackRate)
          : f.startTime !== this.startTime + h / this.playbackRate &&
            (f.startTime = this.startTime + h / this.playbackRate);
      },
      get timeline() {
      ...
      get finished() {
        ...
        this._finishedPromise ||
          (-1 == v.animationsWithPromises.indexOf(this) &&
            v.animationsWithPromises.push(this),
      ...
      set currentTime(f) {
        this._updatePromises();
        this._animation.currentTime = isFinite(f)
          ? f
          : Math.sign(f) * Number.MAX_VALUE;
        this._register();
      ...
      set startTime(f) {
        this._updatePromises();
        this._animation.startTime = isFinite(f)
          ? f
          : Math.sign(f) * Number.MAX_VALUE;
        this._register();
        this._forEachChild(function (h, d) {
      ...
      _forEachChild: function (f) {
        ...
        if ("pending" != this.playState) {
          var d = this.effect._timing,
            a = this.currentTime;
          null !== a &&
            (a = y.calculateIterationProgress(
  ...
  (function (y, v, k) {
    ...
    v.removeMulti = function (e) {
      for (var m = [], n = 0; n < e.length; n++) {
        var l = e[n];
        l._parent
          ? (-1 == m.indexOf(l._parent) && m.push(l._parent),
            l._parent.children.splice(l._parent.children.indexOf(l), 1),
            (l._parent = null),
            d(l))
          : l._animation &&
            l._animation.effect == l &&
            (l._animation.cancel(),
            (l._animation.effect = new KeyframeEffect(null, [])),
            l._animation._callback &&
              (l._animation._callback._animation = null),
    ...
    v.KeyframeEffect = function (e, m, n, l) {
      ...
      "function" == typeof m
        ? (y.deprecated(
          ...
          (this._normalizedKeyframes = m))
        : (this._normalizedKeyframes = new f(m));
      this._keyframes = m;
    ...
    v.KeyframeEffect.prototype = {
      ...
      clone: function () {
        ...
        var e = new KeyframeEffect(
          this.target,
          [],
          y.cloneTimingInput(this._timingInput),
          this._id
        );
    ...
    v.bindAnimationForKeyframeEffect = function (e) {
      e.effect &&
        "function" == typeof e.effect._normalizedKeyframes &&
        v.bindAnimationForCustomEffect(e);
    };
    var b = [];
    v.awaitStartTime = function (e) {
      null === e.startTime &&
        e._isGroup &&
        (0 == b.length && requestAnimationFrame(h), b.push(e));
    };
  ...
  (function (y, v, k) {
    ...
    v.bindAnimationForCustomEffect = function (b) {
      ...
      var r = function () {
        ...
        null !== t &&
          ((t = y.calculateIterationProgress(
            y.calculateActiveDuration(n),
            t,
            n
          )),
          isNaN(t) && (t = null));
        t !== l &&
          (e ? m(t, g, b.effect) : m(t, b.effect, b.effect._animation));
        l = t;
      };
      r._animation = b;
      r._registered = !1;
  ...
  (function (y, v, k) {
    ...
    h.prototype = {
      ...
      _rebuild: function () {
        for (var d = this; d; )
          "auto" === d.timing.duration &&
            (d._timing.duration = d.activeDuration),
            (d = d._parent);
        this._animation && this._animation._rebuildUnderlyingAnimation();
      },
      ...
      clone: function () {
        for (
          var d = y.cloneTimingInput(this._timingInput), a = [], c = 0;
      ...
      d.onsample = function (b) {
        ...
        g &&
          ...
          (null == b
            ...
            : 0 == b &&
              0 > g.playbackRate &&
              (c || (c = y.normalizeTimingInput(g.effect.timing)),
              (b = y.calculateIterationProgress(
                y.calculateActiveDuration(c),
                -1,
                c
              )),
              isNaN(b) || null == b) &&
              (g._forEachChild(function (e) {
                e.currentTime = -1;
              }),
              g._removeChildAnimations()));
      };
