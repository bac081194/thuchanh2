...
*/
  ...
  function ab() {
    ...
    window.EventTarget
      ? (E(window.EventTarget.prototype, a),
    ...
    Sa
      ? (E(Element.prototype, Za),
        ...
        E(HTMLElement.prototype, ["children", "innerHTML", "className"]))
      : (Wa(Element.prototype, a),
        Wa(Element.prototype, {
          ...
          innerHTML: {
            ...
            set: function (b) {
              ...
              d =
                this.namespaceURI && this.namespaceURI !== Xa.namespaceURI
                  ? Xa.createElementNS(this.namespaceURI, d)
                  : Xa.createElement(d);
              d.innerHTML = b;
              for (
    ...
    Sa
      ? (E(Document.prototype, Za), E(Document.prototype, ["activeElement"]))
      : Wa(Document.prototype, a);
  ...
  function lb(a) {
    ...
    return { Ma: d, capture: b, once: c, La: kb ? a : b };
  }
  var mb = {
      blur: !0,
      focus: !0,
  ...
  var sb = {
      get composed() {
        void 0 === this.__composed &&
          (jb
            ? (this.__composed =
                "focusin" === this.type || "focusout" === this.type || jb(this))
            : !1 !== this.isTrusted && (this.__composed = mb[this.type]));
        return this.__composed || !1;
      },
      composedPath: function () {
        this.__composedPath ||
          (this.__composedPath = pb(this.__target, this.composed));
  ...
  tb &&
    (Object.defineProperty(sb, "eventPhase", {
      get: function () {
  ...
  function zb(a) {
    ...
    try {
      ...
      for (h = 0; h < b.length; h++) {
        ...
        if (m || d)
          if (
            ((f = m ? Event.AT_TARGET : Event.BUBBLING_PHASE),
            xb(a, l, "bubble"),
            a.fa)
          )
            break;
  ...
  function Bb(a) {
    Fa();
    return !w.R && this instanceof Node && !ra(document, this)
      ? (a.__target || Cb(a, this), zb(a))
      ...
      if ("function" === l || "object" === l)
        if (
          ...
          h = function (n) {
            ...
            if (
              (!y(m) && "slot" !== m.localName) ||
              -1 != n.composedPath().indexOf(m)
            )
              if (n.composed || -1 < n.composedPath().indexOf(m))
                if (wb(n) && n.target === n.relatedTarget)
                  ...
                  var ia =
                    "function" === l
                      ? b.call(m, n)
                      : b.handleEvent && b.handleEvent(n);
                  m !== d &&
                    (t
                      ? (Object.defineProperty(n, "currentTarget", t),
                        (t = null))
                      : delete n.currentTarget,
                    A
                      ? (Object.defineProperty(n, "eventPhase", A), (A = null))
                      : delete n.eventPhase);
                  return ia;
                }
          };
          b[ib].push({ node: m, type: a, capture: f, cc: h });
  ...
  function Eb(a, b, c) {
    if (b) {
      ...
      g &&
        ((f = Ab(g, f, a, c)),
        -1 < f && ((e = g.splice(f, 1)[0].cc), g.length || (b[ib] = void 0)));
  ...
  function Pb(a, b, c, d) {
    ...
    for (m = 1; m < d; m++)
      for (n = 1; n < h; n++)
        if (a[l + n - 1] === c[g + m - 1]) b[m][n] = b[m - 1][n - 1];
        else {
          var t = b[m - 1][n] + 1,
            A = b[m][n - 1] + 1;
          b[m][n] = t < A ? t : A;
    ...
    insertBefore: function (a, b) {
      ...
      var l =
        ...
        m =
          ...
          (!Zb || a.nodeType === Node.DOCUMENT_FRAGMENT_NODE);
      if (m || l)
        l && (g = g || Wb(a)),
          Xb(a, function (n) {
      ...
      x(this) &&
        ...
        (h = v(this)),
        h.root
          ? ((f = !1), la(this) && h.root.s())
          : c && "slot" === this.localName && ((f = !1), c.s()));
      f
        ? ((c = y(this) ? this.host : this),
          b
            ? ((b = dc(b)), c.__shady_native_insertBefore(a, b))
...
*/
  ...
  var oc = {
      ...
      get children() {
        return x(this)
          ? ta(
              Array.prototype.filter.call(va(this), function (a) {
                return a.nodeType === Node.ELEMENT_NODE;
              })
            )
    ...
    J = C(
      ((oc.append = function () {
        this.__shady_insertBefore(
          D.apply(null, q(r.apply(0, arguments))),
          null
        );
      }),
      (oc.prepend = function () {
      ...
      (oc.replaceChildren = function () {
        for (
          var a = r.apply(0, arguments), b;
          null !== (b = this.__shady_firstChild);
        ...
        mc(a, function () {
          ...
          return Aa(
            d.map(function (f) {
              var g = f.Ja,
                h = g.length - 1;
              return c(e, g[h]) ? { target: e, N: f, O: e, index: h } : [];
            })
          );
        })
      );
        ...
        b.map(function (e) {
          ...
          if (" " === l) {
            ...
            for (g = g.__shady_parentElement; g; g = g.__shady_parentElement)
              c(g, m) && l.push({ target: f, N: h, O: g, index: e });
            return l;
          }
          if (">" === l)
            return (
              (g = g.__shady_parentElement),
              c(g, m) ? { target: f, N: h, O: g, index: e } : []
            );
          if ("+" === l)
            return (g = g.__shady_previousElementSibling) && c(g, m)
              ? { target: f, N: h, O: g, index: e }
              : [];
          if ("~" === l) {
            l = [];
            for (
...
*/
  var sc = C({
    ...
    before: function () {
      var a = this.__shady_parentNode;
      null !== a &&
        a.__shady_insertBefore(D.apply(null, q(r.apply(0, arguments))), this);
    },
    remove: function () {
      var a = this.__shady_parentNode;
  ...
  function uc(a, b) {
    "slot" === b
      ? ((a = a.__shady_parentNode), la(a) && v(a).root.s())
      : "slot" === a.localName &&
        "name" === b &&
        (b = I(a)) &&
        (b.Jb(a), b.s());
  ...
  var vc = C({
    ...
    setAttribute: function (a, b) {
      this.ownerDocument !== tc
        ? this.__shady_native_setAttribute(a, b)
        : Tb(this, a, b) ||
          (this.__shady_native_setAttribute(a, b), uc(this, a));
    },
    removeAttribute: function (a) {
      this.ownerDocument !== tc
        ...
        : (this.__shady_native_removeAttribute(a), uc(this, a));
    },
    toggleAttribute: function (a, b) {
      if (this.ownerDocument !== tc)
        return this.__shady_native_toggleAttribute(a, b);
      if (!Tb(this, a, ""))
        return (b = this.__shady_native_toggleAttribute(a, b)), uc(this, a), b;
  ...
  var Ac = document.implementation.createHTMLDocument("inert"),
    Bc = C({
      get innerHTML() {
        return x(this)
          ? Ra("template" === this.localName ? this.content : this, va)
      ...
      set innerHTML(a) {
        if ("template" === this.localName) this.__shady_native_innerHTML = a;
          ...
          b =
            this.namespaceURI && this.namespaceURI !== Ac.namespaceURI
              ? Ac.createElementNS(this.namespaceURI, b)
              : Ac.createElement(b);
          for (
            w.j ? (b.__shady_native_innerHTML = a) : (b.innerHTML = a);
  ...
  var Dc = C({
    assignedNodes: function (a) {
      if ("slot" === this.localName) {
        ...
        b && y(b) && b.W();
        return (b = v(this))
          ? (a && a.flatten ? b.K : b.assignedNodes) || []
          : [];
      }
    },
  ...
  var Hc = "__shady_native_" + ka(),
    Ic = C({
      ...
      elementFromPoint: function (a, b) {
        return this === document && w.useNativeDocumentEFP
  ...
  var Jc = window.document,
    Kc = C({
      importNode: function (a, b) {
        if (a.ownerDocument !== Jc || "template" === a.localName)
  ...
  var M = {
      ...
      Element: [
        ...
        sc,
        ic,
        !w.j || "innerHTML" in Element.prototype ? Bc : null,
        window.HTMLSlotElement ? null : Dc,
      ],
      HTMLElement: [Cc, L],
      HTMLSlotElement: [Dc],
    ...
    for (a = 0; a < this.g.length; a++) {
      ...
      if (!c.assignedNodes.length)
        for (var d = b.__shady_firstChild; d; d = d.__shady_nextSibling)
          this.ua(d, b);
      (d = (d = v(b.__shady_parentNode)) && d.root) &&
        (d.wa() || d.I) &&
        d._renderSelf();
  ...
  k.ua = function (a, b) {
    ...
    b
      ? (u(b).assignedNodes.push(a), (c.assignedSlot = b))
      : (c.assignedSlot = void 0);
  ...
  k.Ya = function () {
    ...
    for (a = 0; a < b.length; a++)
      (c = b[a]), this.Ib(c === this ? this.host : c, this.Za(c));
  };
  k.Za = function (a) {
    var b = [];
    for (a = a.__shady_firstChild; a; a = a.__shady_nextSibling)
  ...
  k.Ib = function (a, b) {
    for (
      var c = ua(a), d = Pb(b, b.length, c, c.length), e = 0, f = 0, g = void 0;
      e < d.length && (g = d[e]);
      e++
    ) {
    ...
    for (f = void 0; e < d.length && (f = d[e]); e++)
      for (g = c[f.index], h = f.index; h < f.index + f.aa; h++)
        (l = b[h]), a.__shady_native_insertBefore(l, g), c.splice(h, 0, l);
  };
  k.fb = function () {
    this.D = this.D || [];
    this.g = this.g || [];
  ...
  k.Ea = function (a) {
    return a.sort(function (b, c) {
      ...
      for (var d = Wc(c), e = 0; e < b.length; e++) {
        ...
        var f = d[e];
        if (c !== f)
          return (b = va(c.__shady_parentNode)), b.indexOf(c) - b.indexOf(f);
      }
    });
  };
  k.wb = function (a) {
          ...
          (a.prototype.connectedCallback =
            ...
            (a.prototype.disconnectedCallback =
              a.prototype.__shadydom_disconnectedCallback =
                function () {
                  O
                    ? this.isConnected || Xc.set(this, !1)
  ...
  k.replaceChildren = function () {
    return this.node.__shady_replaceChildren.apply(
      this.node,
      q(r.apply(0, arguments))
    );
  };
  k.after = function () {
  ...
  k.replaceWith = function () {
    return this.node.__shady_replaceWith.apply(
      this.node,
      q(r.apply(0, arguments))
    );
  };
...
*/
    ...
    a.parent &&
      ...
      a.atRule
        ? 0 === c.indexOf("@media")
          ? (a.type = 4)
          : c.match(kd) &&
            ((a.type = 7), (a.keyframesName = a.selector.split(jd).pop()))
        : (a.type = 0 === c.indexOf("--") ? 1e3 : 1));
    if ((c = a.rules))
  ...
  window.ShadyCSS &&
    ...
    (sd = window.ShadyCSS.cssBuild);
  var R = !(!window.ShadyCSS || !window.ShadyCSS.disableRuntime);
  window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss
    ? (qd = window.ShadyCSS.nativeCss)
    : window.ShadyCSS
    ? (rd(window.ShadyCSS), (window.ShadyCSS = void 0))
    : rd(window.WebComponents && window.WebComponents.flags);
  var S = qd;
  var td =
      /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
    ud = /(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi,
  ...
  function Dd(a, b, c, d) {
    ...
    e.textContent = a;
    if (
      window.enableHotReplacement &&
      (a = document.head.querySelector("style[scope=" + b + "]"))
    )
      return a.parentElement.replaceChild(e, a), e;
    Ed(e, c, d);
    return e;
  }
  var U = null;
  ...
  function Nd(a, b) {
    ...
    return c && ((c = c.didTransformSelector), "function" === typeof c)
      ? c(a, b)
      : a;
  }
  function Od() {}
    ...
    if (
      (a =
        "template" === a.localName
          ? (a.content || a._content || a).childNodes
  ...
  k.element = function (a, b, c) {
    if (b)
      if (a.classList)
        ...
        c
          ? d && ((b = d.replace("style-scope", "").replace(b, "")), Id(a, b))
          : Id(a, (d ? d + " " : "") + "style-scope " + b);
      }
  };
  function Qd(a, b, c) {
    var d = W;
  ...
  k.la = function (a, b, c) {
    ...
    a = a.replace(Xd, function (l, m, n) {
      e ||
        ((l = d.Fb(n, m, b, c)), (e = e || l.stop), (m = l.Lb), (n = l.value));
      return m + n;
    });
    g && (a = this.zb(a, h));
    f && (a = this.Ia(a));
  ...
  k.Fb = function (a, b, c, d) {
    ...
    0 <= a.indexOf(":host")
      ? (a = this.Hb(a, d))
      : 0 !== e && (a = c ? this.Ha(a, c) : a);
    c = !1;
    0 <= e && ((b = ""), (c = !0));
    if (c) {
      var f = !0;
      c &&
        (a = a.replace(Zd, function (g, h) {
          return " > " + h;
        }));
    }
  ...
  k.Gb = function (a) {
    return a.match(":host")
      ? ""
      : a.match("::slotted")
      ? this.la(a, ":not(.style-scope)")
      : Nd(this.Ha(a.trim(), ":not(.style-scope)"), ":not(.style-scope)");
  };
  ...
  function le(a, b, c) {
    b &&
      (b =
        0 <= b.indexOf(";")
          ? me(a, b, c)
          : Hd(b, function (d, e, f, g) {
              if (!e) return d + g;
              (e = le(a, c[e], c)) && "initial" !== e
  ...
  function oe(a, b, c, d) {
    ...
    if (b.l.B) {
      ...
      if (g || h)
        (c = e),
          h && (b.o || (b.o = W.Ga(b, W.la, W.ta(a), e)), (c = b.o || e)),
          g && "html" === e && (c = b.o || b.ec),
          d({ qa: c, Rb: h, dc: g });
    }
  }
        ...
        if (!Q && !Cd(m) && m.cssText) {
          ...
          if (m.Ka)
            if (null == m.ca) {
              m.ca = [];
              for (var A in l)
                (t = l[A]), (t = t(n)), n !== t && ((n = t), m.ca.push(A));
            } else {
  ...
  he.prototype.bb = function (a, b, c) {
    ...
    if (!Q && a)
      for (var d = 0, e = a[d]; d < a.length; e = a[++d])
        this.Cb(e, c), (b[e.keyframesName] = this.pb(e));
    return b;
  };
  ...
  he.prototype.Db = function (a, b, c, d) {
    ...
    d = "." + d;
    for (
      var e = Kd(a.o), f = 0, g = e.length, h = void 0;
      f < g && (h = e[f]);
      f++
    )
  ...
  function re(a, b) {
    ...
    a.textContent = T(d, function (e) {
      ...
      e.l &&
        e.l.cssText &&
        ((f = f.replace(md, "").replace(nd, "")), (e.cssText = me(c, f, b)));
    });
  }
  ...
  if (!(Q || (window.ShadyDOM && window.ShadyDOM.handlesDynamicScoping))) {
    var Ce = new MutationObserver(Be),
      De = function (a) {
        Ce.observe(a, { childList: !0, subtree: !0 });
      };
    if (
      window.customElements &&
      !window.customElements.polyfillWrapFlushCallback
      ...
      window.HTMLImports
        ? window.HTMLImports.whenReady(Ee)
  ...
  k.prepareTemplateDom = function (a, b) {
    if (!R) {
      ...
      Q ||
        "shady" === c ||
        a._domPrepared ||
        ((a._domPrepared = !0), Pd(a.content, b));
    }
  };
  ...
  k.cb = function () {
    return !this.m && window.ShadyCSS && window.ShadyCSS.ApplyShim
      ? ((this.m = window.ShadyCSS.ApplyShim),
  ...
  k.eb = function () {
    ...
    !this.h &&
      ...
      ((this.h = window.ShadyCSS.CustomStyleInterface),
  ...
  k.styleElement = function (a, b) {
    if (R) {
      ...
      this.ia(a) || (this.ha = !0),
        ...
        S
          ? Me(this, a, c)
          : (this.flush(), this.ma(a, c), c.oa && c.oa.length && this.Va(a, c));
  };
  k.za = function (a, b) {
    a.L = a.L || {};
    Object.assign(a.L, b);
  ...
  function Me(a, b, c) {
    ...
    if (
      ...
      Q &&
        ...
        (a.textContent = Sd(b, c.v));
      c.v = e._styleAst;
    }
  }
  k.ka = function (a) {
    return (a = Jd(a).getRootNode().host)
      ? X(a) || this.Ba(a)
        ? a
        : this.ka(a)
      : this.H;
  ...
  k.Va = function (a, b) {
    ...
    Q
      ? l.J
        ? ((l.J.textContent = g), (e = l.J))
        : g && (e = Dd(g, h, a.shadowRoot, l.placeholder))
      : e
      ? e.parentNode ||
        (ge && -1 < g.indexOf("@media") && (e.textContent = g),
        Ed(e, null, l.placeholder))
      : g && (e = Dd(g, h, null, l.placeholder));
    e &&
      ((e._useCount = e._useCount || 0), l.J != e && e._useCount++, (l.J = e));
    h = e;
    Q ||
      ((e = b.u),
      (l = g = a.getAttribute("class") || ""),
      f &&
        (l = g.replace(new RegExp("\\s*x-scope\\s*" + f + "\\s*", "g"), " ")),
      (l += (l ? " " : "") + "x-scope " + e),
      g !== l && Id(a, l));
