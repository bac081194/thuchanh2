...
(function (f, h) {
  ...
  function v(a, b, c, e) {
    "function" == typeof a.removeEventListener
      ...
      : "function" == typeof a.P && a.P("on" + b, c);
  }
  function m(a) {
    try {
  ...
  if (
    ...
    d.prototype.L = function (a) {
      a = (a || "0px").split(/\s+/).map(function (b) {
        ...
        return { value: parseFloat(b[1]), unit: b[2] };
      });
      a[1] = a[1] || a[0];
      a[2] = a[2] || a[0];
      a[3] = a[3] || a[1];
    ...
    d.prototype.K = function () {
      this.l ||
        ((this.l = !0),
        this.m
          ? (this.o = setInterval(this.g, this.m))
          : (u(f, "resize", this.g, !0),
            u(h, "scroll", this.g, !0),
            this.C &&
              "MutationObserver" in f &&
              ((this.j = new MutationObserver(this.g)),
              this.j.observe(h, {
                attributes: !0,
                childList: !0,
                characterData: !0,
    ...
    d.prototype.g = function () {
      ...
      this.h.forEach(function (c) {
        ...
        l
          ? a && k
            ? this.I(l, c) && this.i.push(c)
            : l && l.isIntersecting && this.i.push(c)
          : this.i.push(c);
      }, this);
